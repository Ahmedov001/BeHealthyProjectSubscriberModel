...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.BaseUser", b =>
                {
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.Meal", b =>
                {
                    ...
                    b.Property<string>("DietProgramId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DietProgramId");

                    b.ToTable("Meal");
                });

            modelBuilder.Entity("BeHealthyProject.Entities.MealItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.Subscriber", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Food", b =>
                {
                    ...
                    b.Property<float>("CarbohydratesTotalG")
                        .HasColumnType("real");

                    b.Property<float>("CholesterolMg")
                        .HasColumnType("real");

                    b.Property<float>("FatSaturatedG")
                        .HasColumnType("real");

                    b.Property<float>("FatTotalG")
                        .HasColumnType("real");

                    b.Property<float>("FiberG")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.Dietitian", b =>
                {
                    b.HasBaseType("BeHealthyProject.Entities.BaseUser");
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.User", b =>
                {
                    b.HasBaseType("BeHealthyProject.Entities.BaseUser");
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.Meal", b =>
                {
                    b.HasOne("BeHealthyProject.Entities.DietProgram", null)
                        .WithMany("Meals")
                        .HasForeignKey("DietProgramId");
                });

            modelBuilder.Entity("BeHealthyProject.Entities.MealItem", b =>
                {
                    b.HasOne("BeHealthyProject.Entities.Meal", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.Subscriber", b =>
                {
                    b.HasOne("BeHealthyProject.Entities.Dietitian", null)
                        .WithOne("Subscribers")
                        .HasForeignKey("BeHealthyProject.Entities.Subscriber", "DietitianId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BeHealthyProject.Entities.BaseUser", null)
                        .WithMany()
